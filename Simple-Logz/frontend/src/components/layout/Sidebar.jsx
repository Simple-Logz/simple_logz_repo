...
/* ââ User section pinned to sidebar bottom âââââââââââââââââââââââ */
function SidebarUserSection({ onThemeToggle, theme }) {
  ...
  return (
    <>
      {/* Trigger row â sits at bottom of sidebar */}
      <button
        ref={triggerRef}
        onClick={openMenu}
        style={{
      ...
      {/* Dropdown â portal so it overlays everything */}
        ...
        >
          ...
          <div style={{ padding:"3px 0" }}>
            ...
            >
              ...
              {mfaEnabled === null
                ? <span style={{ marginLeft:"auto", fontSize:10, color:"var(--t3)" }}>â¦</span>
                : mfaEnabled
...
export default function Sidebar({ onThemeToggle, theme, open, onToggle }) {
  ...
  return (
    <>
      {/* Floating trigger â only visible when sidebar is closed */}
      {!open && (
        <div
          style={{
