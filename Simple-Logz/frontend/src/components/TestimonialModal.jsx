          ...
          <form onSubmit={submit} style={{ padding:"14px 20px 20px", display:"flex", flexDirection:"column", gap:14 }}>
            ...
            <div className="form-group" style={{ margin:0 }}>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Tell us how SimpleLogz helped youâ¦"
                value={quote}
              ...
              <div style={{ fontSize:11, color: quote.length < 20 && quote.length > 0 ? "var(--red)" : "var(--t3)", marginTop:3 }}>
                {quote.length}/300 Â· min 20 chars
              </div>
            </div>
            ...
            <div style={{ display:"flex", justifyContent:"flex-end", gap:8 }}>
              ...
              <button type="submit" className="btn btn-primary btn-sm" disabled={saving}>
                {saving ? <><span className="spinner" style={{ width:11, height:11, borderWidth:2 }}/> Submittingâ¦</> : "Submit review"}
              </button>
            </div>
          </form>
        )}
