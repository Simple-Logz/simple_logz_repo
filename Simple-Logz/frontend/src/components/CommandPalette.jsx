...
/* ââ Clean SVG icons ââââââââââââââââââââââââââââââââââââââââ */
const Icons = {
...
const PAGES = [
  ...
  { label:"Community",  desc:"Forum â share tips & solutions",        path:"/forum",     Icon: Icons.Community, group:"Product"  },
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* ââ Search input ââââââââââââââââââââââââââââââââ */}
        <div style={{
          ...
          <input
            ...
            onKeyDown={handleKey}
            placeholder="Search pages and featuresâ¦"
            style={{
        ...
        {/* ââ Results list ââââââââââââââââââââââââââââââââ */}
        <div
          ref={listRef}
        ...
        <div style={{
          ...
          {[["â â", "navigate"], ["âµ", "open"], ["esc", "close"]].map(([key, hint]) => (
