      ...
      <div className="container">
        ...
        {profile?.plan !== "developer" && (
          <div className={styles.upgradeBanner}>
            ...
            <Link to="/pricing" className="btn btn-primary btn-sm">Upgrade â $5/month</Link>
          </div>
        )}
              ...
              <tbody>
                {history.map(h => (
                  <tr key={h.id}>
                    ...
                    <td style={{color:"var(--t2)"}}>{h.source || "â"}</td>
              ...
              <div>
                ...
                <div className="card" style={{display:"flex",flexDirection:"column",gap:16}}>
                  ...
                  <div className="form-group">
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:16,paddingTop:4}}>
                      ...
                      <div style={{display:"flex",flexDirection:"column",gap:8}}>
                        ...
                        >
                          {avatarUploading ? <><span className="spinner" style={{width:12,height:12,borderWidth:2}}/> Uploadingâ¦</> : "Upload photo"}
                        </button>
                  ...
                  <button className="btn btn-primary" style={{alignSelf:"flex-start"}} onClick={saveName} disabled={saving}>
                    {saving ? <><span className="spinner"/>Savingâ¦</> : "Save changes"}
                  </button>
                </div>
              </div>
            )}
                ...
                <div className="card" style={{marginBottom:14}}>
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
                    <div>
                      ...
                      <div style={{fontSize:14,color:"var(--t2)",marginTop:4}}>{profile?.plan === "developer" ? "Unlimited analyses â $5/month" : "2 analyses per day"}</div>
                    </div>
                    {profile?.plan === "developer"
