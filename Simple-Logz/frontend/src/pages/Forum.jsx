...
export default function Forum() {
  ...
  // Reactions: { [commentId]: emoji } â tracks what THIS user reacted with
  ...
  // ââ Load threads âââââââââââââââââââââââââââââââââââââââââââââ
  useEffect(() => {
    loadThreads();
  }, [category, search]);
  ...
  // ââ Open thread âââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ File pick for new post ââââââââââââââââââââââââââââââââââââ
  ...
  // ââ File pick for comment image âââââââââââââââââââââââââââââââ
  ...
  // ââ Submit new thread âââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ React to comment âââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Delete thread âââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ THREAD DETAIL VIEW ââââââââââââââââââââââââââââââââââââââââ
  if (view === "thread") {
    return (
      <div className={styles.page}>
        <div className="container" style={{paddingTop:24,paddingBottom:60,maxWidth:780}}>
          <button className={styles.back} onClick={goList}>â Back to forum</button>
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{display:"flex",alignItems:"flex-start",gap:10,marginBottom:10}}>
                      ...
                      {isLoggedIn && user?.id === activeThread.profiles?.id && (
                        ...
                        >
                          <IconTrash/> {deletingId === activeThread.id ? "Deletingâ¦" : "Delete"}
                        </button>
                      )}
                    </div>
                ...
                {!isLoggedIn ? (
                  ...
                  <>
                    <textarea
                      ...
                      placeholder="Share your experience, solution, or questionâ¦"
                    ...
                    <div style={{display:"flex",gap:8,marginTop:10,alignItems:"center"}}>
                      ...
                      >
                        {commenting ? <><span className="spinner"/>Postingâ¦</> : "Post reply"}
                      </button>
                    </div>
                    <input
                      ref={commentFileRef}
  ...
  // ââ NEW POST VIEW âââââââââââââââââââââââââââââââââââââââââââââ
  if (view === "new") {
    ...
    return (
      <div className={styles.page}>
        <div className="container" style={{paddingTop:24,paddingBottom:60,maxWidth:740}}>
          <button className={styles.back} onClick={() => setView("list")}>â Back</button>
          ...
          <div className="card" style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <div style={{display:"flex",gap:10,paddingTop:4}}>
              ...
              >
                {posting ? <><span className="spinner"/>Publishingâ¦</> : "Publish post"}
              </button>
