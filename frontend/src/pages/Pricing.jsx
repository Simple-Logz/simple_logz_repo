      ...
      <div className="container">
        ...
        <div className={styles.valueSection}>
          ...
          <div className={styles.valueGrid}>
            {[
              { icon: "🗂️", title: "Projects", body: "Every application gets its own space. Incidents, timelines, runbooks, and team notes — all organised by the service that generated them." },
              { icon: "📈", title: "AI Incident Timeline", body: "The AI automatically connects related incidents across time. Spot patterns like recurring memory pressure or repeated authentication failures before they become outages." },
              { icon: "💯", title: "Project Health Score", body: "A live score based on incident frequency, severity, and trend. Know at a glance whether your service is improving or degrading." },
              { icon: "📚", title: "Known Issues Library", body: "When an error appears again, SimpleLogz surfaces every previous occurrence and what fixed it. Stop solving the same problem twice." },
              { icon: "📋", title: "AI Runbooks", body: "Click 'Generate Runbook' after any analysis. SimpleLogz produces a step-by-step operations playbook tailored to that exact error. Saved to your project permanently." },
              { icon: "👥", title: "Team Collaboration", body: "Add up to 5 engineers to a project. Comment on incidents, mark them resolved, assign ownership, and build shared knowledge — all inside SimpleLogz." },
            ].map(v => (
