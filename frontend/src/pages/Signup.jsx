...
export default function Signup() {
  const { signInWithGoogle, signInWithGithub, signInWithMicrosoft, signInWithApple, signUpWithEmail } = useAuth();
    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <div className={styles.oauthGrid}>
          ...
          <button className={styles.oauthBtn} onClick={signInWithMicrosoft}>
            <svg width="18" height="18" viewBox="0 0 24 24"><rect x="1" y="1" width="10" height="10" fill="#F25022"/><rect x="13" y="1" width="10" height="10" fill="#7FBA00"/><rect x="1" y="13" width="10" height="10" fill="#00A4EF"/><rect x="13" y="13" width="10" height="10" fill="#FFB900"/></svg> Microsoft
          </button>
          <button className={styles.oauthBtn} onClick={signInWithApple}>
        ...
        <div className="divider" style={{margin:"20px 0"}}>or sign up with email</div>
        ...
        <form onSubmit={handleEmail} className={styles.form}>
          ...
          <div className="form-group">
            ...
            <input className="form-input" type="password" value={password} onChange={e=>setPass(e.target.value)} placeholder="Min 8 characters" required minLength={8}/>
          </div>
