...
// ── Local FAQ fallback (works without backend) ─────────────────
const FAQ = [
  {
    keys: ["what is simplelogz", "about simplelogz", "tell me about", "what does"],
    answer: "SimpleLogz is an AI-powered log analysis tool. Paste any error log — from Node.js, Docker, Kubernetes, Nginx, AWS, and more — and get an instant plain-English diagnosis with step-by-step fix instructions.",
  },
  {
...
export default function ChatWidget() {
  ...
  async function send(text) {
    ...
    try {
      ...
      // network error or timeout — fall through to FAQ
    }
