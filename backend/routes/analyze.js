...
router.post("/", analyzeLimiter, optionalAuth, async (req, res) => {
  ...
  const systemPrompt = `You are a senior DevOps/SRE engineer and log analysis expert. Analyze error logs and return precise, structured JSON. Be direct and actionable. Return ONLY valid JSON — no markdown fences, no preamble.`;
